...
('s_version','7'),
('latest_file',''),
('file_public_key','vMwCoCxzs6cTcgmHrj4q1'),
('cache_id','1000'),
...
('admin_layout','hostbilling/layouts/admin.tpl'),
('client_layout','hostbilling/layouts/client.tpl'),
('route_controller_directory','hostbilling'),
('disabled_theme_options','1'),
('number_pad', '5'),
...
CREATE TABLE `domain_prices` (`id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
                                 `extension` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
                                 `whois_server` varchar(150) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
                                 `register` decimal(16,2) UNSIGNED NOT NULL,
                                 `transfer` decimal(16,2) UNSIGNED NOT NULL,
                                 `renew` decimal(16,2) UNSIGNED NOT NULL,
                                 `registration_provider_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
                                 `automatic_registration` tinyint(1) NOT NULL DEFAULT '0',
                                 `created_at` timestamp NULL DEFAULT NULL,
                                 `updated_at` timestamp NULL DEFAULT NULL,
                                 PRIMARY KEY (`id`)
                             )
...
CREATE TABLE `hosting_plan_groups` (
                                 `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
                                 `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
                                 `slug` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `hosting_plans` (
                                 ...
                                 `slug` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
                                 `type` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
                                 `api_name` varchar(150) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
                                 `image` varchar(255) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
                                 `icon` varchar(255) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
                                 `group_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
                                 `one_time_fee` decimal(16,2) NOT NULL DEFAULT '0.00',
                                 `setup_fee` decimal(16,2) NOT NULL DEFAULT '0.00',
                                 `price_monthly` decimal(16,2) NOT NULL DEFAULT '0.00',
                                 `price_quarterly` decimal(16,2) NOT NULL DEFAULT '0.00',
                                 `price_half_yearly` decimal(16,2) NOT NULL DEFAULT '0.00',
                                 `price_yearly` decimal(16,2) NOT NULL DEFAULT '0.00',
                                 `price_two_years` decimal(16,2) NOT NULL DEFAULT '0.00',
                                 `price_three_years` decimal(16,2) NOT NULL DEFAULT '0.00',
                                 `features` text COLLATE utf8mb4_unicode_ci,
                                 `addons` text COLLATE utf8mb4_unicode_ci,
                                 `require_domain_name` tinyint(1) NOT NULL DEFAULT '0',
                                 `allow_free_domain` tinyint(1) NOT NULL DEFAULT '0',
                                 `allow_multiple_quantities` tinyint(1) NOT NULL DEFAULT '0',
                                 `recurring` tinyint(1) NOT NULL DEFAULT '1',
                                 `featured` tinyint(1) NOT NULL DEFAULT '0',
                                 `hosting_provider_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
                                 `create_automatically` tinyint(1) NOT NULL DEFAULT '0',
                                 `short_description` text COLLATE utf8mb4_unicode_ci,
                                 `description` text COLLATE utf8mb4_unicode_ci,
                                 `welcome_email` text COLLATE utf8mb4_unicode_ci,
                                 `api_features` text COLLATE utf8mb4_unicode_ci,
                                 `created_at` timestamp NULL DEFAULT NULL,
                                 `updated_at` timestamp NULL DEFAULT NULL,
                                 PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `shopping_carts` (
                                 ...
                                 `items_count` int(8) UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE `hosting_orders` (
                                  ...
                                  `type` enum('hosting','other') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'hosting',
                                  `status` enum('Active','Fraud','Pending','Cancelled','Expired','Moved') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Pending',
                                  `contact_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
                                  `admin_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
                                  ...
                                  `domain_type` enum('owned','new_registration','transfer') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'owned',
                                  `free_domain_registration` tinyint(1) NOT NULL DEFAULT '0',
                                  `addons` text COLLATE utf8mb4_unicode_ci,
                                  `automation_run` tinyint(1) NOT NULL DEFAULT '0',
                                  `automation_suspended` tinyint(1) NOT NULL DEFAULT '0',
                                  `automation_terminated` tinyint(1) NOT NULL DEFAULT '0',
                                  `automation_result` text COLLATE utf8mb4_unicode_ci,
                                  `activation_subject` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                                  `activation_message` text COLLATE utf8mb4_unicode_ci,
                                  ...
                                  `next_renewal_amount` decimal(16,2) NOT NULL DEFAULT '0.00',
                                  `created_at` timestamp NULL DEFAULT NULL,
                                  `updated_at` timestamp NULL DEFAULT NULL,
                                  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `domain_orders` (
                                  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
                                  `tracking_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
                                  `type` enum('registration','transfer') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'registration',
                                  `status` enum('Active','Fraud','Pending','Cancelled','Expired','Moved') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Pending',
                                  `contact_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
                                  `admin_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
                                  ...
                                  `invoice_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
                                  `domain` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                                  `years` tinyint(3) NOT NULL DEFAULT '1',
                                  `addons` text COLLATE utf8mb4_unicode_ci,
                                  `automation_run` tinyint(1) NOT NULL DEFAULT '0',
                                  `activation_subject` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                                  `activation_message` text COLLATE utf8mb4_unicode_ci,
                                  ...
                                  `username` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                                  `password` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                                  `epp_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                                  `date` date DEFAULT NULL,
                                  `payment_term` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                                  `total` decimal(16,2) NOT NULL DEFAULT '0.00',
                                  `next_renewal_date` date DEFAULT NULL,
...
CREATE TABLE `hosting_servers` (
                                 ...
                                 `name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                                 `ip_address` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `domain_registration_providers` (
                                   `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
                                   `type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                                   `name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                                   `ip_address` varchar(150) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
