...
function content_612b8f52a80d26_05719755 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_1809249649612b8f52a64b83_52846085', "content");
?>


<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_1595246100612b8f52a7fa19_43316382', 'script');
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, ((string)$_smarty_tpl->tpl_vars['layouts_admin']->value));
}
/* {block "content"} */
class Block_1809249649612b8f52a64b83_52846085 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'content' => 
  array (
    0 => 'Block_1809249649612b8f52a64b83_52846085',
  ),
);
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form id="form_main" method="post">
                    ...
                    <div class="mb-3">
                        <label for="input_name"><?php ob_start();
echo __('Name');
$_prefixVariable1 = ob_get_clean();
echo $_prefixVariable1;?>
</label>
                        <input class="form-control" name="name" id="input_name"
                                <?php if (!empty($_smarty_tpl->tpl_vars['subscription']->value)) {?>
                                    value="<?php ob_start();
echo $_smarty_tpl->tpl_vars['subscription']->value->name;
...
subscriptions/subscribe/</span>
                            <input type="text" aria-label="Slug" name="slug" id="input_slug" class="form-control"
                                    <?php if (!empty($_smarty_tpl->tpl_vars['subscription']->value)) {?>
                                        value="<?php ob_start();
echo $_smarty_tpl->tpl_vars['subscription']->value->slug;
...
echo $_prefixVariable5;?>
                        ...
                        <input class="form-control" name="price" id="input_price"
                                <?php if (!empty($_smarty_tpl->tpl_vars['subscription']->value)) {?>
                                    value="<?php ob_start();
echo $_smarty_tpl->tpl_vars['subscription']->value->price;
...
echo $_prefixVariable7;?>
                        ...
                        <input class="form-control" name="button_text" id="input_button_text"
                                <?php if (!empty($_smarty_tpl->tpl_vars['subscription']->value)) {?>
                                    value="<?php ob_start();
echo $_smarty_tpl->tpl_vars['subscription']->value->button_text;
...
echo $_prefixVariable9;?>
                        ...
                        <input class="form-control" name="stripe_pricing_id" id="input_stripe_pricing_id"
                                <?php if (!empty($_smarty_tpl->tpl_vars['subscription']->value)) {?>
                                    value="<?php ob_start();
echo $_smarty_tpl->tpl_vars['subscription']->value->stripe_pricing_id;
...
echo $_prefixVariable11;?>
                        ...
                        <textarea class="form-control" rows="5" id="input_description" name="description"><?php if (!empty($_smarty_tpl->tpl_vars['subscription']->value)) {
ob_start();
echo $_smarty_tpl->tpl_vars['subscription']->value->description;
...
echo $_prefixVariable12;
                    ...
                    <div id="div_features">
                        ...
                        <?php if (!empty($_smarty_tpl->tpl_vars['subscription']->value) && $_smarty_tpl->tpl_vars['subscription']->value->features) {?>
...
/* {/block "content"} */
/* {block 'script'} */
class Block_1595246100612b8f52a7fa19_43316382 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'script' => 
  array (
    0 => 'Block_1595246100612b8f52a7fa19_43316382',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
        ...
        $(function () {
            ...
            $form_main.on('submit',function (event) {
                ...
                axios.post(base_url + 'subscriptions/subscription',$form_main.serialize()).then(function (response) {
                    window.location = base_url + 'subscriptions/subscription/' + response.data.id;
